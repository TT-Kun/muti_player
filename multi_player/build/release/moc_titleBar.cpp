...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTitleBarENDCLASS_t qt_meta_stringdata_CLASSTitleBarENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 15),  // "maximizeClicked"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 13),  // "doubleClicked"
        QT_MOC_LITERAL(40, 17),  // "onMinimizeClicked"
        QT_MOC_LITERAL(58, 17),  // "onMaximizeClicked"
        QT_MOC_LITERAL(76, 14)   // "onCloseClicked"
    },
    "TitleBar",
    "maximizeClicked",
    "",
...
void TitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->maximizeClicked(); break;
        case 1: _t->doubleClicked(); break;
        case 2: _t->onMinimizeClicked(); break;
        case 3: _t->onMaximizeClicked(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &TitleBar::maximizeClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TitleBar::*)();
            if (_t _q_method = &TitleBar::doubleClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
