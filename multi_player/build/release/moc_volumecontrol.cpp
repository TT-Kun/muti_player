...
static constexpr auto qt_meta_stringdata_CLASSvolumeControlENDCLASS = QtMocHelpers::stringData(
    "volumeControl",
    "volumeChanged",
    "",
    "volume",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSvolumeControlENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSvolumeControlENDCLASS_t qt_meta_stringdata_CLASSvolumeControlENDCLASS = {
    {
        QT_MOC_LITERAL(0, 13),  // "volumeControl"
        QT_MOC_LITERAL(14, 13),  // "volumeChanged"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 6),  // "volume"
        QT_MOC_LITERAL(36, 11),  // "muteToggled"
        QT_MOC_LITERAL(48, 5),  // "muted"
        QT_MOC_LITERAL(54, 19)   // "onVolumeIconClicked"
    },
    "volumeControl",
    "volumeChanged",
    "",
...
void volumeControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->muteToggled((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 2: _t->onVolumeIconClicked(); break;
        default: ;
        }
        ...
        {
            using _t = void (volumeControl::*)(bool );
            if (_t _q_method = &volumeControl::muteToggled; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void volumeControl::muteToggled(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
